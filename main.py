...
pygame.display.set_caption("3D walking game by Pesochnuyy")

ypos = 10
angle = 60  
numberofcollides = 0
xpos = 20 # player's parameters
...
while running:
    ...
    for point in ray_collisions:
        ...
        if point[0] != "NULL" and point[1]!= "NULL":
            ...
            wall_color[0] -= int(point_distance)
            wall_color[1] -= int(point_distance) * 0.3
            wall_color[2] -= int(point_distance) * 0.3
            try:
            ...
            try:
                pygame.draw.rect(screen, tuple(wall_color), (current_x, space_between_rectange, RECT_WIDTH, rectangle_height))
            except:
                   pygame.draw.rect(screen, "Black", (current_x, space_between_rectange, RECT_WIDTH, rectangle_height))                                             
